...
import {
  ...
  TrendingUp  // ✅ NEW: icon for Loan Tracking
} from "lucide-react";
...
const Sidebar = () => {
  ...
  const adminLoanLinks = [
    ...
    // ✅ NEW: Loan Tracking page
    { path: "/dashboard/loan/tracking",        name: "Loan Tracking",    icon: <TrendingUp size={20} /> },
  ];
  ...
  const adminInsuranceLinks = [
    ...
    { path: "/dashboard/insurance/commissions",      name: "Agent Payouts",      icon: <DollarSign size={20} /> },
    { path: "/dashboard/insurance/reports",          name: "Analytics & Reports",icon: <BarChart3 size={20} /> },
